...
class NodeManager:
    ...
    def select(self, num_of_clients = None, fraction = None, timeout = None):
        ...
        if num_of_clients == None and fraction:
    ...
    #wait for the number of clients to connect, indefinitely. unless a timeout is specified, then just return after timeout    
