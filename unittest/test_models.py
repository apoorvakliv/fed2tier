...
def create_train_test_for_LeNet():
    """ Verify the LeNet-5 CNN model using one node 
...
def create_train_test_for_resnet18():
    """ Verify the ResNet18 CNN model using one node
    by implementing the following function """
...
def create_train_test_for_resnet50():
    """ Verify the ResNet50 CNN model using one node
    by implementing the following function """
...
def create_train_test_for_vgg16():
    """ Verify the VGG16 CNN model using one node
    by implementing the following function """
...
def create_train_test_for_AlexNet():
    """ Verify the AlexNet CNN model using one node
    by implementing the following function """
